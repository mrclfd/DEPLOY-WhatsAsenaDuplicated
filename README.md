...
[![Get String Session](https://repl.it/badge/github/phaticusthiccy/WhatsAsenaDuplicated)](https://repl.it/@phaticusthiccy/WhatsAsena-QR)

[![Deploy on Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/mrclfd/WhatsAsenaDuplicated)
[![Deploy on Railway](https://railway.app/button.svg)](<https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2Fmrclfd%2FWhatsAsenaDuplicated&plugins=postgresql&envs=ASENA_SESSION%2CNO_LOG%2CANTI_LINK%2CAUTO_BIO%2CSUDO%2CLANGUAGE%2CHANDLERS%2CSEND_READ%2CHEROKU%2CBLOCK_CHAT%2CREMOVE_BG_API_KEY%2CLH_API_KEY%2CNO_ONLINE&optionalEnvs=ANTI_LINK%2CAUTO_BIO%2CSUDO%2CBLOCK_CHAT%2CREMOVE_BG_API_KEY%2CLH_API_KEY&ASENA_SESSIONDesc=Kode+sesi+yang+kamu+dapatkan+setelah+meng-scan+QR+Whatsapp+web.&NO_LOGDesc=Set+true+jika+anda+tidak+ingin+melihat+log+Bot.&ANTI_LINKDesc=Pendeteksi+link+digrup+dan+nantinya+akan+otomatis+dikeluarkan.&AUTO_BIODesc=Membuat+bio+bergerak+seperti+waktu+yang+berubah+setiap+5+detiknya.&SUDODesc=%22Membuat+orang+lain+dapat+mengakses+botmu+secara+total.+Masukkan+nomornya%2C+contoh%3A+62888777666+pisahkan+dengan+tanda+koma%28%2C%29+untuk+menambahkan+lebih+dari+1+nomor.&LANGUAGEDesc=Bahasa+yang+digunakan+bot%2C+en+%3D+inggris+dan+id+%3D+indonesia.&HANDLERSDesc=Simbol+untuk+memanggil+perintah.&SEND_READDesc=Otomatis+membaca+pesan+yang+dikirim+ke-bot+anda.&HEROKUDesc=Dimana+Anda+mendeploy%3F+jika+di+Heroku+set+ke+true.&BLOCK_CHATDesc=Pilih+di+obrolan+mana+bot+tidak+akan+berfungsi+di+sana.+Contoh%3A+62xxxxxxx+%26%26+62xxxxx-1xxx+atau+62xxxx%2C62xxx+dst.&REMOVE_BG_API_KEYDesc=Api+key+untuk+plugin+rbg.+Dapatkan+disini+https%3A%2F%2Fremove.bg&LH_API_KEYDesc=Api+key+untuk+mengaktifkan+beberapa+fitur.+Dapatkan+disini+https%3A%2F%2Fapi.lolhuman.xyz&NO_ONLINEDesc=Supaya+tidak+terlihat+online.&LANGUAGEDefault=ID&HANDLERSDefault=%5E%5B.%5D&SEND_READDefault=false&HEROKUDefault=false&NO_ONLINEDefault=true>)<br>
